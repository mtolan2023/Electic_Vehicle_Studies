...
btn.addEventListener("click", function() {
    ...
    d3.json('input/json_files/us_zip.json').then(function(zipData) {
...
d3.json("input/json_files/us_state_geojson.json").then(function(data) {
...
d3.json('input/json_files/alt_fuel_stations.json').then(function(stationData) {
